...
<body style="font-size: 18px;">
    ...
    <form method="POST" action="hasil-form-register.php" class="container mt-5">
        <fieldset class="border-dark p-3 rounded" style="background-color: lightyellow;">
    ...
    <div class="form-group row">
        ...
        <div class="input-group">
            ...
            <input id="nim" name="nim" placeholder="*0110124255" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 Digit Angka">>
        </div>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="input-group">
            ...
            <input id="nama_lengkap" name="nama_lengkap" placeholder="*Afina Yasyifa" type="text" class="form-control" required="required" minlength="3" maxlength="50">
        </div>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="email" name="email" placeholder="*0110124255@student.nurulfikri.ac.id" type="email" class="form-control" required="required">
            </div>
        </div>
    </div> 
    <div class="form-group row">
